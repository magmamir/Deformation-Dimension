summon block_display ~ ~ ~ {Tags:["mmdp.deformation.painting_custodian.choice","mmdp.deformation.painting_custodian","mmdp.temp.painting_custodian_new","global.ignore.kill","global.ignore.pos","global.ignore.gui","global.ignore"]}
...
tag @s add mmdp.deformation.painting.choice