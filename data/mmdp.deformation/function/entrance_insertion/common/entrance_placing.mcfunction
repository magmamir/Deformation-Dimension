execute if entity @s[y_rotation=89..91] run summon item_display ~0.49 ~-0.185 ~ {\
	Tags:["mmdp.deformation.outdimension_block","mmdp.deformation_entrance","mmdp.deformation_entrance.block","mmdp.deformation_entrance.east","global.ignore.pos","global.ignore.kill","global.ignore.gui","global.ignore","smithed.block","global.block"],\
...
execute if entity @s[y_rotation=-91..-89] run summon item_display ~-0.49 ~-0.185 ~ {\
	Tags:["mmdp.deformation.outdimension_block","mmdp.deformation_entrance","mmdp.deformation_entrance.block","mmdp.deformation_entrance.west","global.ignore.pos","global.ignore.kill","global.ignore.gui","global.ignore","smithed.block","global.block"],\
	item_display:"none",item:{id:"minecraft:jigsaw",count:1,components:{"minecraft:custom_model_data":222995}},\
	transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.51f,0.185f,0f],scale:[1.01f,1.01f,1.01f]},\
	Passengers:[\
		{id:"minecraft:interaction",\
...
execute if entity @s[y_rotation=179..181] run summon item_display ~ ~-0.185 ~0.49 {\
	Tags:["mmdp.deformation.outdimension_block","mmdp.deformation_entrance","mmdp.deformation_entrance.block","mmdp.deformation_entrance.south","global.ignore.pos","global.ignore.kill","global.ignore.gui","global.ignore","smithed.block","global.block"],\
	item_display:"none",item:{id:"minecraft:jigsaw",count:1,components:{"minecraft:custom_model_data":222995}},\
...
execute if entity @s[y_rotation=-1..1] run summon item_display ~ ~-0.185 ~-0.49 {\
	Tags:["mmdp.deformation.outdimension_block","mmdp.deformation_entrance","mmdp.deformation_entrance.block","mmdp.deformation_entrance.north","global.ignore.pos","global.ignore.kill","global.ignore.gui","global.ignore","smithed.block","global.block"],\
	item_display:"none",item:{id:"minecraft:jigsaw",count:1,components:{"minecraft:custom_model_data":222995}},\
	transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0.0f,0.185f,-0.51f],scale:[1.01f,1.01f,1.01f]},\
	Passengers:[\
		{id:"minecraft:interaction",\
