execute if block ~1 ~ ~ #mmdp.deformation:deformable_blocks run summon item_display ~ ~ ~ {\
...
execute if block ~ ~1 ~ #mmdp.deformation:deformable_blocks unless predicate mmdp.deformation:chance/0.3 run summon item_display ~ ~ ~ {\
...
#Рандомизирование текстуры засчёт биноминальной веротяности с учётом скора mmdp.deformation.counter
