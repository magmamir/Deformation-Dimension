...
execute store result score @s mmdp.deformation.counter run random value 500..501
...
execute if score temp.log.2 mmdp.deformation.tech matches ..4 summon minecraft:marker run return run function mmdp.deformation:entrance_insertion/common/spreader_creation
