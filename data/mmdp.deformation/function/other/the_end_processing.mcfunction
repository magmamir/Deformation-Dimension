...
execute if score spreading_roots mmdp.deformation.tech matches 1.. if score timer.20 mmdp.deformation.tech matches 0 as @e[type=minecraft:marker,tag=mmdp.deformation.roots_spreader] at @s run function mmdp.deformation:entrance_insertion/common/spreading_process
