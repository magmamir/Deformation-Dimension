particle item{item:{id:"minecraft:jigsaw",count:1,components:{"minecraft:item_model":"mmdp.deformation:projectiles","minecraft:custom_model_data":3}}} ~ ~ ~ 1.35 0.7 1.35 0.1 75
