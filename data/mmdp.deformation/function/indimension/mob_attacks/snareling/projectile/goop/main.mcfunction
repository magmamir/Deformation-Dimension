...
execute if score @s mmdp.deformation.counter matches -125..-10 if predicate mmdp.deformation:chance/0.5 run particle item{item:{id:"minecraft:jigsaw",count:1,components:{"minecraft:custom_model_data":222996}}} ~ ~ ~ 1.25 0.1 1.25 0.05 3
