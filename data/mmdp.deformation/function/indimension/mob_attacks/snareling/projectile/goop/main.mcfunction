...
execute if score @s mmdp.deformation.counter matches -125..-10 if predicate mmdp.deformation:chance/0.5 run particle item{item:{id:"minecraft:jigsaw",count:1,components:{"minecraft:item_model":"mmdp.deformation:projectiles","minecraft:custom_model_data":3}}} ~ ~ ~ 1.25 0.1 1.25 0.05 3
