...
execute at @n[type=item_display,tag=mmdp.temp.this_goop] run particle minecraft:item{item:{id:"minecraft:jigsaw",components:{"minecraft:item_model":"mmdp.deformation:projectiles","minecraft:custom_model_data":2}}} ~ ~ ~ 0.01 0.5 0.01 0.125 35
