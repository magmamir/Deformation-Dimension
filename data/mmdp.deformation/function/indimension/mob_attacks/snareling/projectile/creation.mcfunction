summon item_display ~ ~ ~ {\
    ...
    item_display:"fixed",item:{id:"minecraft:jigsaw",count:1,components:{"minecraft:item_model":"mmdp.deformation:projectiles","minecraft:custom_model_data":{"floats":[2]}}} }
...
execute at @p run summon item_display ~ ~0.75 ~ {\
     ...
     item_display:"fixed",item:{id:"minecraft:jigsaw",count:1,components:{"minecraft:item_model":"mmdp.deformation:projectiles","minecraft:custom_model_data":{"floats":[3]}}} }
