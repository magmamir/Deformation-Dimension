...
scoreboard players set temp.snr.x mmdp.deformation.tech 7
...
function mmdp.deformation:indimension/mob_attacks/snareling/correction_patch/player_interrupt_attack_2 with storage mmdp:deformation score_translation
