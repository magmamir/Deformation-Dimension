...
particle minecraft:item{item:{id:"minecraft:jigsaw",components:{"minecraft:item_model":"mmdp.deformation:projectiles","minecraft:custom_model_data":1}}} ^ ^ ^ 0 0 0 0.075 15
