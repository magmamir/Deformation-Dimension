...
data modify storage mmdp:deformation_mobs mini_bosses[{name:"blastling"}] merge value {name:"blastling",id:"iron_golem",num:1b,nbt:\
    ...
    HandItems:[{},{id:"minecraft:structure_block",count:1,components:{"minecraft:custom_model_data":222970,"minecraft:custom_data":{mmdp:{deformation:{invisible:1b,mob:{blastling:{model:1b}}}}}}}],\
        HandDropChances:[0.085F,0.000F],\
    attributes:[{id:"minecraft:generic.armor",base:12},{id:"minecraft:generic.attack_damage",base:15},{id:"minecraft:generic.max_health",base:75},{id:"minecraft:generic.scale",base:1.00}],\
        Health:75f}}
...
data modify storage mmdp:deformation_mobs mini_bosses[{name:"watchling"}] merge value {name:"watchling",id:"iron_golem",num:2b,nbt:\
    ...
    HandItems:[{},{id:"minecraft:structure_block",count:1,components:{"minecraft:custom_model_data":222970,"minecraft:custom_data":{mmdp:{deformation:{invisible:1b,mob:{watchling:{model:1b,texture:1b}}}}}}}],\
        HandDropChances:[0.085F,0.000F],\
    attributes:[{id:"minecraft:generic.armor",base:8},{id:"minecraft:generic.armor_toughness",base:2},{id:"minecraft:generic.attack_damage",base:12.5},{id:"minecraft:generic.knockback_resistance",base:0.5},{id:"minecraft:generic.max_health",base:95},{id:"minecraft:generic.movement_speed",base:0.305},{id:"minecraft:generic.scale",base:0.85}],\
        Health:85f}}
...
data modify storage mmdp:deformation_mobs mini_bosses[{name:"snareling"}] merge value {name:"snareling",id:"enderman",num:3b,nbt:\
    ...
    HandItems:[{},{id:"minecraft:structure_block",count:1,components:{"minecraft:custom_model_data":222970,"minecraft:custom_data":{mmdp:{deformation:{invisible:1b,mob:{snareling:{model:1b}}}}}}}],\
        HandDropChances:[0.085F,0.000F],\
    attributes:[{id:"minecraft:generic.armor",base:3},{id:"minecraft:generic.attack_damage",base:2},{id:"minecraft:generic.max_health",base:45}],\
        Health:45f}}
...
data modify storage mmdp:deformation_mobs mini_bosses[{name:"mawling"}] merge value {name:"mawling",id:"warden",num:4b,nbt:\
    ...
    HandItems:[{},{id:"minecraft:structure_block",count:1,components:{"minecraft:custom_model_data":222970,"minecraft:custom_data":{mmdp:{deformation:{invisible:1b,mob:{mawling:{model:1b}}}}}}}],\
        HandDropChances:[0.085F,0.000F],\
    ...
    attributes:[{id:"minecraft:generic.attack_damage",base:8},{id:"minecraft:generic.knockback_resistance",base:0.5},{id:"minecraft:generic.max_health",base:65},{id:"minecraft:generic.scale",base:0.8},{id:"minecraft:generic.movement_efficiency",base:0.05}],\
        Health:55f}}
...
data modify storage mmdp:deformation_mobs mini_bosses[{name:"delusioner"}] merge value {name:"delusioner",id:"illusioner",num:-1b,nbt:\
    ...
    HandItems:[{id:"minecraft:bow",count:1,components:{"minecraft:enchantments":{levels:{"minecraft:power":7}}}},{id:"minecraft:structure_block",count:1,components:{"minecraft:custom_model_data":222970,"minecraft:custom_data":{mmdp:{deformation:{invisible:1b,mob:{deformated:{illusioner:1b}}}}}}}],\
        HandDropChances:[0.000F,0.000F],\
    attributes:[{id:"minecraft:generic.armor",base:5},{id:"minecraft:generic.follow_range",base:48},{id:"minecraft:generic.max_health",base:24}],\
        Health:24f}}
...
data modify storage mmdp:deformation_mobs mobs[{name:"black_skeleton"}] merge value {name:"black_skeleton",id:"skeleton",num:1b,nbt:\
    ...
    HandItems:[{id:"minecraft:stone_sword",count:1},{id:"minecraft:structure_block",count:1,components:{"minecraft:custom_model_data":222970,"minecraft:custom_data":{mmdp:{deformation:{invisible:1b,mob:{deformated:{skeleton:2b}}}}}}}],\
        HandDropChances:[0.085F,0.000F],\
    attributes:[{id:"minecraft:generic.max_health",base:30},{id:"minecraft:generic.attack_damage",base:3}],\
        Health:30f}}
...
data modify storage mmdp:deformation_mobs mobs[{name:"white_skeleton"}] merge value {name:"white_skeleton",id:"skeleton",num:2b,nbt:\
    ...
    HandItems:[{id:"minecraft:bow",count:1,components:{"minecraft:enchantments":{levels:{"minecraft:power":5}}}},{id:"minecraft:structure_block",count:1,components:{"minecraft:custom_model_data":222970,"minecraft:custom_data":{mmdp:{deformation:{invisible:1b,mob:{deformated:{skeleton:1b}}}}}}}],\
        HandDropChances:[0.020F,0.000F],\
    attributes:[{id:"minecraft:generic.max_health",base:30}],\
        Health:30f}}
...
data modify storage mmdp:deformation_mobs mobs[{name:"local_enderman"}] merge value {name:"local_enderman",id:"enderman",num:4b,nbt:\
    ...
    HandItems:[{},{id:"minecraft:structure_block",count:1,components:{"minecraft:custom_model_data":222970,"minecraft:custom_data":{mmdp:{deformation:{invisible:1b,mob:{deformated:{enderman:1b}}}}}}}],\
        HandDropChances:[0.085F,0.000F],\
    attributes:[{id:"minecraft:generic.max_health",base:24},{id:"minecraft:generic.scale",base:0.95},{id:"minecraft:generic.movement_speed",base:0.24}],\
        Health:35f}}
...
data modify storage mmdp:deformation_mobs mobs[{name:"naturalized_spider"}] merge value {name:"naturalized_spider",id:"spider",num:5b,nbt:\
    ...
    HandItems:[{},{id:"minecraft:structure_block",count:1,components:{"minecraft:custom_model_data":222970,"minecraft:custom_data":{mmdp:{deformation:{invisible:1b,mob:{deformated:{spider:1b}}}}}}}],\
        HandDropChances:[0.085F,0.000F],\
    attributes:[{id:"minecraft:generic.armor",base:6},{id:"minecraft:generic.attack_damage",base:4},{id:"minecraft:generic.max_health",base:24},{id:"minecraft:generic.scale",base:0.9},{id:"minecraft:generic.movement_speed",base:0.36}],\
        Health:24f}}
...
data modify storage mmdp:deformation_mobs mobs[{name:"missgeburt"}] merge value {name:"missgeburt",id:"spider",num:6b,nbt:\
    ...
    HandItems:[{},{id:"minecraft:structure_block",count:1,components:{"minecraft:custom_model_data":222970,"minecraft:custom_data":{mmdp:{deformation:{invisible:1b,mob:{deformated:{spider:2b}}}}}}}],\
        HandDropChances:[0.085F,0.000F],\
    attributes:[{id:"minecraft:generic.attack_damage",base:3},{id:"minecraft:generic.max_health",base:16},{id:"minecraft:generic.scale",base:1.22},{id:"minecraft:generic.movement_speed",base:0.42}],\
        Health:16f}}
...
data modify storage mmdp:deformation_mobs mobs[{name:"mini_missgeburt"}] merge value {name:"mini_missgeburt",id:"spider",num:-1b,nbt:\
    ...
    HandItems:[{},{id:"minecraft:structure_block",count:1,components:{"minecraft:custom_model_data":222970,"minecraft:custom_data":{mmdp:{deformation:{invisible:1b,mob:{deformated:{spider:2b}}}}}}}],\
        HandDropChances:[0.085F,0.000F],\
    attributes:[{id:"minecraft:generic.attack_damage",base:2},{id:"minecraft:generic.max_health",base:8},{id:"minecraft:generic.scale",base:0.3},{id:"minecraft:generic.movement_speed",base:0.34}],\
        Health:8}}
...
data modify storage mmdp:deformation_mobs mobs[{name:"deformatted_pillager"}] merge value {name:"deformatted_pillager",id:"pillager",num:-2b,nbt:\
    ...
    HandItems:[{id:"minecraft:crossbow",count:1,components:{"minecraft:enchantments":{levels:{"minecraft:quick_charge":3}}}},{id:"minecraft:structure_block",count:1,components:{"minecraft:custom_model_data":222970,"minecraft:custom_data":{mmdp:{deformation:{invisible:1b,mob:{deformated:{pillager:1b}}}}}}}],\
        HandDropChances:[0.085F,0.000F],\
    attributes:[{id:"minecraft:generic.max_health",base:32}],\
        Health:32f}}