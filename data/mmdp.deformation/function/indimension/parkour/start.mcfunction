...
tag @s add mmdp.deformation.parkour.start
...
attribute @s minecraft:generic.fall_damage_multiplier modifier add mmdp.deformation:parkour_guardian -1 add_multiplied_total